    ...
    <main class="container mx-auto px-4 py-4 flex items-center justify-center">
        <div class="flex flex-col md:flex-row gap-8">
            ...
            <div class="w-full md:w-1/2 bg-gray-100 rounded-lg flex">
                <img src="https://cdn.leonardo.ai/users/5087e2c4-de41-4a88-becc-108a49d3f1f4/generations/d0fa2136-ebba-41e1-8e81-2470e8c8ac5d/Leonardo_Lightning_XL_Image_inspirante_dun_tudiant_moderne_et_0.jpg" alt="Image montrant un étudiant garçon souriant" class="w-full h-full object-cover rounded-lg">
            </div>
            ...
            <div class="w-full md:w-1/2 border border-gray-200 rounded-lg p-8 overflow-hidden">
                ...
                <p class="text-center text-gray-600 mb-8">connecte-toi à eduquest et commence ton aventure d'apprentissage.</p>

                <form>
                    <div class="mb-4">
                        <label for="email" class="block mb-2">email address</label>
                        <input type="email" id="email" class="w-full border border-gray-300 rounded-md p-2" required>
                    </div>

                    <div class="mb-4">
                        <label for="password" class="block mb-2">password</label>
                        <input type="password" id="password" class="w-full border border-gray-300 rounded-md p-2" required>
                    </div>
                ...
                <div class="text-center mb-4">
                    <p class="text-gray-600">connectez-vous avec</p>
                </div>
                ...
                <div class="text-center mb-4">
                    <p class="text-gray-600">pas encore inscrit ? <a href="#" class="text-gray-600 hover:underline">inscrivez-vous</a></p>
                </div>
            </div>
        </div>
    </main>
